...
To assess whether the effect sizes we obtained are *meaningful* (i.e., does the overall effect size fall within the boundaries of a smallest effect size of interest or not?) we conducted equivalence tests. We determined the smallest effect size of interest to be .1
...
### Citations
Using citation data from Google Scholar we analysed the link between and article's yearly citations with its (aggregated) effect size and (average) sample size.
```{r, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE}
