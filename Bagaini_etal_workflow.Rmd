...
We followed the approach by Koricheva et al. (2013) and compared the effect size and variance of the first study ( Study 1 in Westbrook et at., 2013) with the mean effect size and variance of the rest of the studies.
```{r, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE}
# get data
