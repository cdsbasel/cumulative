...
png("figures/cma_time_study.png", height = 25, width = 15, units = "cm", res = 600)
...
### cumulative forest plot
png("figures/cma_risk_study.png", height = 30, width = 20, units = "cm", res = 600)
...
### cumulative forest plot
png("figures/cma_altruism_study.png", height = 20, width = 15, units = "cm", res = 600)
