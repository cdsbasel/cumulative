...
#' `conduct_sensitivity_rho()` computes a pooled effect size using the information from "effect_sizes_pref.csv" by 
...
#' @examples
#' conduct_sensitivity_rho(dat = risk_es, rho_vec = c(.1,.3,.5,.7,.9))
